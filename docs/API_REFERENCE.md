...
| 파라미터 | 타입 | 필수 | 기본값 | 설명 |
|----------|------|------|--------|------|
| `platform_id` | string | ❌ | - | 플랫폼 ID 필터 |
| `community_id` | integer | ❌ | - | 커뮤니티 ID 필터 |
| `limit` | integer | ❌ | 20 | 조회할 게시글 수 (1-100) |
| `offset` | integer | ❌ | 0 | 건너뛸 게시글 수 |
    ...
    "items": [
        {
            "id": 1,
            "platform_id": "naver",
            "community_article_id": "4330417",
            "community_id": 3,
            "title": "성형 후기 공유합니다",
            "content": "안녕하세요...",
            "images": "[]",
            "writer_nickname": "성형후기러",
            "writer_id": "user123",
            "like_count": 15,
            "comment_count": 8,
            "view_count": 120,
            "created_at": "2025-08-15T09:00:00",
            "category_name": "A+여우야★성형카페",
            "collected_at": "2025-08-15T10:30:00"
        }
    ],
    "total": 150,
    "limit": 20,
...
|----------|------|------|--------|------|
| `platform_id` | string | ❌ | - | 플랫폼 ID 필터 |
| `community_article_id` | string | ❌ | - | 게시글 ID 필터 |
| `limit` | integer | ❌ | 20 | 조회할 댓글 수 (1-100) |
| `offset` | integer | ❌ | 0 | 건너뛸 댓글 수 |
    ...
    "items": [
        {
            ...
            "platform_id": "naver",
            "community_article_id": "4330417",
            "community_comment_id": "165795581",
            "content": "정말 도움이 되는 후기네요!",
            "writer_nickname": "궁금이",
            "writer_id": "user456",
            "created_at": "2025-08-15T10:15:00",
